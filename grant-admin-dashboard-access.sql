...
-- =============================================================================
-- VERIFICATION QUERIES AND COMPLETION SUMMARY
-- =============================================================================
...
BEGIN
    ...
    LOOP
        RAISE NOTICE '- Organization: %, Role: %, Dashboard Permissions: %', 
            verification_result.organization_name, 
            verification_result.role_name, 
            verification_result.dashboard_permissions_count;
    END LOOP;
